            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('Descargar').addEventListener('click', async function() {
                    ...
                    if (imgData1) {
                        ...
                        doc.setFontSize(10);
                        doc.text('DEPARTAMENTO: SANITARIOS', 105, 23, { align: 'center' });
                        doc.setFontSize(13);
                ...
                // FUNCION PARA LA VALIDACION DEL REGISTRO DE UN PRODUCTO
                ...
                document.getElementById('search-input').addEventListener('input', function () {
                    ...
                    const page = 1; 
                    const perPage = 6; 
                    const url = `/consulta_sanitarios?page=${page}&per_page=${perPage}&search=${encodeURIComponent(searchTerm)}`;
